...
public class TetrisPanel extends JPanel
{
	...
	public TetrisPanel(boolean useSounds, boolean useAI, boolean useGenetic)
	{
		...
		System.out.println("isHuman:" + isHumanControlled + ". useGenetic: " + useGenetic + ".");
		
		if(!isHumanControlled){
			controller = new TetrisAI(this);
			genetic = new GeneticAIAlgorithm(engine, useGenetic);
